...
def get_mutation_controller_by_name(name: str) -> Type[Abstract_Mutation_Controller]:
    ...
    if name == "SHADE_single":
        from src.car_training.Evolutionary_Algorithms.Mutation_Controllers.SHADE import SHADE_single
        return SHADE_single
    elif name == "SHADE_multiple":
        from src.car_training.Evolutionary_Algorithms.Mutation_Controllers.SHADE import SHADE_multiple
        return SHADE_multiple
    elif name == "Mut_Prob":
        from src.car_training.Evolutionary_Algorithms.Mutation_Controllers.Mut_Prob import Mut_Prob
        return Mut_Prob
    elif name == "Mut_One":
        from src.car_training.Evolutionary_Algorithms.Mutation_Controllers.Mut_One import Mut_One
        return Mut_One
    elif name == "Mut_Prob_Epochs":
        from src.car_training.Evolutionary_Algorithms.Mutation_Controllers.Mut_Prob_Epochs import Mut_Prob_Epochs
